...
class TruthCard extends ConsumerStatefulWidget {
  const TruthCard({super.key});

  @override
  ConsumerState<TruthCard> createState() => _TruthCardState();
}

class _TruthCardState extends ConsumerState<TruthCard> with SingleTickerProviderStateMixin {
  String? _content;
  ...
  Future<void> _loadContent() async {
    ...
    if (ScreenshotMode.enabled) {
      if (mounted) {
        setState(() {
          _content = ScreenshotMode.sampleContent['truth'];
    ...
    final content = await service.getMirrorContent('truth');
    final lastGen = await service.getLastGeneratedTime('truth');
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'What is the truth you\'ve been avoiding?',
              ...
              Expanded(
                child: FadeTransition(
                  ...
                  child: _content != null
                      ...
                      : Center(
                          child: Text(
                            'The mirror doesn\'t lie. It reflects what is, not what you wish to see. In this space, honesty is your only currency.',
                            textAlign: TextAlign.center,
                            style: TextStyle(
                              fontSize: 16,
                              fontWeight: FontWeight.w300,
